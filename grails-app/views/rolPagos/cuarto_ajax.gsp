...
<div class="modal-contenido">
    <g:form class="form-horizontal" name="frmCuarto" role="form" action="save_ajax" method="POST">
        <g:hiddenField name="id" value="${cuarto?.id}" />
        <g:hiddenField name="empleado" value="${empleado?.id}" />
        <g:hiddenField name="tipo" value="cuarto" />
...
<script type="text/javascript">
    var validator = $("#frmCuarto").validate({
