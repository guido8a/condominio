...
<head>
	...
	<script type="text/javascript">
		var spinner24Url = "${resource(dir:'images/', file:'spinner.gif')}";
		var spinner64Url = "${resource(dir:'images/', file:'spinner32.gif')}";

		var spinnerSquare64Url = "${resource(dir: 'images/', file: 'spinner.gif')}";
