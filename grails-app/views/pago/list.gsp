    ...
    <g:if test="${pagoInstanceCount > 0}">
        <g:each in="${pagoInstanceList}" status="i" var="pagoInstance">
            <tr data-id="${pagoInstance.id}">
                ...
                <td>${pagoInstance.documento}</td>
                
                <td><elm:textoBusqueda busca="${params.search}"><g:fieldValue bean="${pagoInstance}" field="observaciones"/></elm:textoBusqueda></td>
                
                <td><g:formatDate date="${pagoInstance.fechaPago}" format="dd-MM-yyyy" /></td>
                
                <td><elm:textoBusqueda busca="${params.search}"><g:fieldValue bean="${pagoInstance}" field="ingreso"/></elm:textoBusqueda></td>
                
                <td><g:fieldValue bean="${pagoInstance}" field="valor"/></td>
...
<elm:pagination total="${pagoInstanceCount}" params="${params}"/>

<script type="text/javascript">
    var id = null;
    function submitFormPago() {
        var $form = $("#frmPago");
